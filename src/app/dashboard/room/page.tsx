...
export default function StudyRoom() {
    ...
    return (
        <PageTransition>
            <div className="flex flex-col h-[calc(100vh-2rem)] m-4 md:m-8 relative overflow-hidden rounded-3xl bg-white/10 backdrop-blur-xl border border-white/50 shadow-[0_8px_32px_rgba(0,0,0,0.08),inset_0_2px_4px_rgba(255,255,255,0.7),inset_0_-1px_2px_rgba(255,255,255,0.3)]">
