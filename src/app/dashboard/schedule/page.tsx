    ...
    return (
        <PageTransition>
            <div className="p-8 md:p-10 h-full overflow-y-auto custom-scrollbar relative">
                ...
                <LiquidGlassCard className="relative z-10" interactive={false} colorHint="bg-indigo-300">
                    <div className="p-6 border-b border-indigo-100/30 bg-white/20 flex justify-between items-center backdrop-blur-sm">
                        <h2 className="text-xl font-bold text-gray-800 flex items-center gap-3">
                            Today's Sessions
                            <span className="bg-indigo-100/50 text-indigo-800 text-xs py-1 px-2.5 rounded-full font-bold">2 sessions</span>
                        </h2>
                    </div>
