        ...
        <PageTransition>
            <div className="p-8 md:p-10 min-h-full relative overflow-y-auto custom-scrollbar">
                ...
                <div className="relative z-10 max-w-7xl mx-auto space-y-10">
                    {/* Header & Create Form */}
                    <LiquidGlassCard className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 p-8" interactive={false} colorHint="bg-emerald-400">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                        {decks.map((deck) => (
                            <Link href={`/dashboard/flashcards/${deck.id}`} key={deck.id} className="block">
                                <LiquidGlassCard className="group flex flex-col min-h-[240px] p-6 cursor-pointer" interactive={true} colorHint="bg-emerald-300">
                                    {/* Hover glow */}
