    ...
    return (
        <PageTransition>
            <div className="flex flex-col h-full p-8 md:p-10 relative overflow-hidden">
                ...
                <LiquidGlassCard className="mb-6 z-10 p-6" interactive={false} colorHint="bg-violet-400">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        ...
                        <div className="flex flex-wrap gap-4 items-center bg-white/40 backdrop-blur-md p-3 rounded-2xl border border-white/50 shadow-sm">
                ...
                <LiquidGlassCard className="flex-1 overflow-hidden group" style={{ cursor: 'crosshair', touchAction: 'none' }} interactive={false} colorHint="bg-blue-300">
                    <canvas
                        ref={canvasRef}
